    ...
    public partial class Form1 : Form
    {
        ...
        */
        private void RunBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select employee and workstation from the list", "Can't run the application", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
       ...
       * DESCRIPTION : This method is being called when form is closing and it relases workstation and employee by calling ReleaseWorkstationAndEmployee()
       * PARAMETERS : object sender: the control that the event was fired from
       *              FormClosingEventArgs e: represents the base class for classes that contain event data, 
       *                           and provides a value to use for events that do not include event data.
       * RETURNS : void
       */
